        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div id="individual" class="card-body users">
                    ...
                    <form method="POST" action="{{ route('admin.initialize') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" spellcheck="false" required>
